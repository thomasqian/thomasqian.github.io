  ...
  156: [function(e, t, n) {
    var r = e("react"),
      o = r.createClass({
        ...
        registerCommands: function() {
          this.setState({
            commands: {
              ...
              'page' : this.openLink('https://thomasqian.github.io/page.html')
        ...
        catFile: function(e) {
          "README.md" === e ? (this.addHistory("### REACT TERMINAL"), this.addHistory("readme under construction"), this.addHistory("type `source` to view the source code")) : this.addHistory("cat: " + e + ": No such file or directory")
        },
        openLink: function(e) {
          return function() {
        ...
        showHelp: function() {
          this.addHistory("help - view this help text"), 
          this.addHistory("github - view my Github profile"), 
          this.addHistory("source - view source code for this page"), 
