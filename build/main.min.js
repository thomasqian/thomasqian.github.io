! function e(t, n, r) {
  ...
  2: [function(e, t, n) {
    ...
    function c(e, t, n, r) {
      ...
      _ && (T || o !== P.compositionStart ? o === P.compositionEnd && T && (c = T.getData()) : T = v.getPooled(t));
    ...
    var A = {
      ...
      U = {
        ...
        extractEvents: function(e, t, n, o) {
          var a, i;
          if (r(t) ? S ? a = u : i = c : _(t) ? k ? a = f : (a = m, i = h) : v(t) && (a = g), a) {
            var s = a(e, t, n);
            if (s) {
  ...
  28: [function(e, t, n) {
    ...
    var M = c.createElement,
      b = c.createFactory,
      x = c.cloneElement,
      _ = m.measure("React", "render", h.render),
      D = {
        Children: {
          map: o.map,
          forEach: o.forEach,
  ...
  33: [function(e, t, n) {
    ...
    function r(e, t) {
      ...
      D.hasOwnProperty(t) && y(n === M.OVERRIDE_BASE), e.hasOwnProperty(t) && y(n === M.DEFINE_MANY || n === M.DEFINE_MANY_MERGED)
    }
    ...
    function o(e, t) {
      if (t) {
        ...
        var n = e.prototype;
        t.hasOwnProperty(R) && _.mixins(e, t.mixins);
        for (var o in t)
    ...
    i.displayName = "ReactDOMComponent", i.Mixin = {
      ...
      _updateDOMProperties: function(e, t) {
        ...
        for (n in e)
          if (!i.hasOwnProperty(n) && e.hasOwnProperty(n))
            ...
            } else R.hasOwnProperty(n) ? E(this._rootNodeID, n) : (u.isStandardName[n] || u.isCustomAttribute(n)) && _.deletePropertyByID(this._rootNodeID, n);
        for (n in i) {
          var c = i[n],
          ...
          else R.hasOwnProperty(n) ? o(this._rootNodeID, n, c, t) : (u.isStandardName[n] || u.isCustomAttribute(n)) && _.updatePropertyByID(this._rootNodeID, n, c)
        }
        a && _.updateStylesByID(this._rootNodeID, a)
      },
      _updateDOMChildren: function(e, t, n) {
        var r = this._currentElement.props,
          ...
          l = null != o || null != i,
          p = null != a || null != s;
        null != u && null == c ? this.updateChildren(null, t, n) : l && !p && this.updateTextContent(""), null != a ? o !== a && this.updateTextContent("" + a) : null != s ? i !== s && _.updateInnerHTMLByID(this._rootNodeID, s) : null != c && this.updateChildren(c, t, n)
      },
      unmountComponent: function() {
      ...
      W = {
        ...
        _updateRootComponent: function(e, t, n, r) {
          return W.scrollMonitor(n, function() {
            _.enqueueElementInternal(e, t), r && _.enqueueCallbackInternal(e, r)
          }), e
        },
        ...
        _renderNewRootComponent: function(e, t, n) {
          ...
          return D.batchedUpdates(m, r, o, t, n), r
        },
  ...
  87: [function(e, t, n) {
    ...
    function r() {
      v(D.ReactReconcileTransaction && C)
    }

    function o() {
      this.reinitializeTransaction(), this.dirtyComponentsLength = null, this.callbackQueue = l.getPooled(), this.reconcileTransaction = D.ReactReconcileTransaction.getPooled()
    }
    ...
    var _ = {
        injectReconcileTransaction: function(e) {
          v(e), D.ReactReconcileTransaction = e
        },
    ...
    function s(e, t, n, r, a) {
      ...
      if (Array.isArray(e))
        ...
        if (C) {
          ...
          f(1 !== e.nodeType);
          var _ = l.extract(e);
          for (var D in _) _.hasOwnProperty(D) && (p = _[D], v = ("" !== t ? t + m : h) + i(D) + m + o(p, 0), g = n + y, y += s(p, v, g, r, a))
        }
      }
      return y
    }
    ...
    var r = e("react"),
      o = r.createClass({
        ...
        registerCommands: function() {
          this.setState({
            commands: {
              ...
              'resume': this.openLink('http://thomasqian.github.io/downloads/resume.pdf')
            }
          })
        },
        listFiles: function() {
        ...
        showWelcomeMsg: function() {
          this.addHistory("Hello, I'm Thomas Qian, a software engineer at Google."), this.addHistory("Type `help` to see what all commands are available")
        },
        catFile: function(e) {
          "README.md" === e ? (this.addHistory("### REACT TERM"), this.addHistory("readme under construction"), this.addHistory("type `source` to view the source code")) : this.addHistory("cat: " + e + ": No such file or directory")
        },
        openLink: function(e) {
          return function() {
        ...
        showHelp: function() {
          this.addHistory("help - this help text"), this.addHistory("github - view my github profile"), this.addHistory("source - browse the code for this page"), this.addHistory("intro - print intro message"), this.addHistory("cat - print contents of a file"), this.addHistory("ls - list files"), this.addHistory("resume - view my resume")
        },
        componentDidMount: function() {
